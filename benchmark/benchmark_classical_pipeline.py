...
def run_pipeline_for_image(run_script, image_path, output_csv_dir, overwrite, extra_args=None):
...
def run_single_benchmark(run_script, eval_script, image_dir, output_dir, ground_truth_csv, overwrite, extra_args=None):
    ...
    for fname in tqdm(image_files, desc="Running classical pipeline"):
        ...
        run_pipeline_for_image(run_script, image_path, output_dir, overwrite, extra_args)
